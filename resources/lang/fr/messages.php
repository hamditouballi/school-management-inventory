...
return [
    ...
    'quantity_mismatch' => 'Écart de quantité détecté',
    'quantities_match' => 'Les quantités correspondent',
    'adjust_quantities' => 'Ajuster les quantités',
    'block_invoice_mismatch' => 'Impossible de créer la facture: les quantités ne correspondent pas aux bons de livraison',
    'bdl_quantity' => 'Qté BDL',
    ...
    'hr_selection' => 'Sélection RH',
    'submitted_proposals' => 'Propositions soumises',
    'waiting_for_hr_selection' => 'En attente que le responsable RH sélectionne les propositions',
    'proposals_finalized' => 'Propositions finalisées',
    'ready_for_procurement' => "Prêt pour l'approvisionnement",
    ...
    'add_bon_de_livraison' => 'Ajouter un bon de livraison',
    'save_draft' => 'Enregistrer le brouillon',
    'draft_saved' => 'Brouillon enregistré avec succès',
    'one_draft_pending' => 'Vous avez 1 brouillon non confirmé. Veuillez le confirmer ou le supprimer avant de fermer.',
    'multiple_drafts_pending' => 'Vous avez :count brouillons non confirmés. Veuillez les confirmer ou les supprimer avant de fermer.',
    ...
    'confirm' => 'Confirmer',
    'invoice_draft_pending' => 'Vous avez un brouillon de facture non confirmé. Veuillez le confirmer ou le supprimer avant de fermer.',
    'draft_deleted' => 'Brouillon supprimé',
    'invoice_created_success' => 'Facture créée avec succès! Le statut du BC est passé à Facturé.',
    'error_creating_invoice' => 'Erreur lors de la création de la facture',
    'add_at_least_one_item' => 'Veuillez ajouter au moins un article',
    'select_bon_de_livraison' => 'Sélectionner les bons de livraison',
    'select_bdl_for_invoice' => 'Sélectionnez le(s) bon(s) de livraison auquel cet facture correspond',
    'selected_count' => 'Sélectionné(s)',
    'select_at_least_one_bdl' => 'Veuillez sélectionner au moins un bon de livraison',
    'linked_bdl' => 'Lié à',
    'delivery_note' => 'Bon de livraison',
    'total_qty' => 'Qté totale',
    'already_invoiced' => 'Déjà facturé',
    'bdl_in_other_draft' => 'Bon de livraison déjà dans un autre brouillon',
    'in_draft' => 'Dans le brouillon',
    'confirm_mark_delivered' => 'Êtes-vous sûr de vouloir marquer ce bon de commande comme livré?',
    'confirm_mark_delivered_warning' => 'Êtes-vous sûr? Une fois marqué comme livré, vous ne pourrez plus télécharger de bons de livraison.',
